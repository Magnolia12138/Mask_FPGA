...
proc create_root_design { parentCell } {
  ...
  set SIMO_0 [ create_bd_port -dir O SIMO_0 ]
  set SOMI_0 [ create_bd_port -dir I SOMI_0 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets iop_pmodb_pmodb_gpio] [get_bd_intf_ports pmodb_gpio] [get_bd_intf_pins slice_pmodb_gpio/gpio]
  ...
  connect_bd_net -net SOMI_0_1 [get_bd_ports SOMI_0] [get_bd_pins spi_0/SOMI]
  ...
  connect_bd_net -net spi_0_CS [get_bd_ports CS_0] [get_bd_pins spi_0/CS]
  connect_bd_net -net spi_0_SCLK [get_bd_ports SCLK_0] [get_bd_pins spi_0/SCLK]
  connect_bd_net -net spi_0_SIMO [get_bd_ports SIMO_0] [get_bd_pins spi_0/SIMO]
  connect_bd_net -net spi_0_rddat1 [get_bd_pins rgbleds_gpio/gpio2_io_i] [get_bd_pins spi_0/rddat1]
